...
export default function NavePage() {
  ...
  return (
    <div style={{ width: '100vw', height: '100dvh', position: 'relative', overflow: 'hidden', background: '#1a1030' }}>
      <Image src="/assets/redesign/nave/fondo.webp" alt="La Nave de Planeta Tiqui" fill priority style={{ objectFit: 'cover', objectPosition: 'center' }} />
      ...
      <div style={{ position: 'relative', zIndex: 1, height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', textAlign: 'center', padding: 24 }}>
        <div>
          ...
          <div style={{ fontSize: 20, fontWeight: 700, marginTop: 12 }}>La Nave de Planeta Tiqui</div>
