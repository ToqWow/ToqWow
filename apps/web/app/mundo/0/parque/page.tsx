...
export default function ParquePage() {
  ...
  return (
    <div style={{ width: '100vw', height: '100dvh', position: 'relative', overflow: 'hidden', background: '#1a1030' }}>
      <Image src="/assets/redesign/parque/fondo.webp" alt="El Parque de los Descubrimientos" fill priority style={{ objectFit: 'cover', objectPosition: 'center' }} />
      ...
      <div style={{ position: 'relative', zIndex: 1, height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', textAlign: 'center', padding: 24 }}>
        <div>
          ...
          <div style={{ fontSize: 20, fontWeight: 700, marginTop: 12 }}>El Parque de los Descubrimientos</div>
